...
- **TKI/ & STKI/**: Sistem utama (Flask Web/GUI Desktop) hibrida (Dense MiniLM + BM25 Sparse). Kajian dan evaluasi mendalam atas 3 kapabilitas intinya terdapat di [[analisis_arsitektur_3_fungsi_stki]].
