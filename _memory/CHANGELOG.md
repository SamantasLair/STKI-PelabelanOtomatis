...
- Skrip ekspansi asinkronus `testing/expand_db_10k.py` untuk menginjeksi 10.000 raw data asli Wikipedia berbahasa Indonesia secara pasif ke dalam SQLite (10x *Scale-Up*).
- Laporan Analisis Kritis (Anti-Glazing) kelemahan PoC Pilar 3 (`testing/analisis_kritis_pilar3.md`) dan peringatan ancaman skalabilitas DB (`testing/analisis_ekspansi_db.md`).
