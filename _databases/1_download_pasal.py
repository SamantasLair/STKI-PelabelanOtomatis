...
INGEST_SCRIPT = os.path.join(PROJECT_ROOT, "ETL_PASAL", "ingest_pasal.py")
...
def main():
    ...
    # Memanggil skrip utama ETL_PASAL/ingest_pasal.py
    # Skrip ini akan mengunduh file JSON mentah ke _RawData/hukum_pasal_id/
    exit_code = os.system(f'python "{INGEST_SCRIPT}"')
    
    if exit_code == 0:
        print("\n[SUCCESS] Pengunduhan berhasil. Lanjutkan ke langkah 2 (2_process_to_sqlite.py).")
    else:
